...
export default function ChatPage({ params }: Params) {
  ...
  // Initial prompt is now processed during project initialization
  // This function is kept for backward compatibility but does nothing
  const triggerInitialPromptIfNeeded = useCallback(() => {
    // Initial prompt is now handled during project creation
    ...
    try {
      ...
      if (r.ok) {
        ...
        if (project.initial_prompt) {
          ...
          // Initial prompt is now processed during project creation, so mark as complete
          setAgentWorkComplete(true);
          localStorage.setItem(`project_${projectId}_taskComplete`, 'true');
          setInitialPromptSent(true); // Mark as sent since it was processed during initialization
        } else {
